...
*/
    ...
    // beide js-Dateien im .html verlinkt sind und Überall "export" davor steht...
    ...
    function clickHandler (_event: MouseEvent): void {
        ...
        // classList = gibt den Klassen Namen eines Elements zurÃ¼ck, es können CSS Klassen hinzugefügt und zurückgesetzt werden (w3Schools)
        openCards ++;
        // Counter
            ...
            // Wenn das Element den Klassen-Namen "hidden" hat, dann:
                ...
                // Klassen-Namen "hidden" wird gelÃ¶scht
