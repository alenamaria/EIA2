...
(function (Aufgabe9) {
    ...
    function init(_event) {
        ...
        for (let i = 0; i < 11; i++) {
            let v = Math.random() * (100 - 150) + 100;
            let w = Math.random() * (600 - 100) + 300;
            let r = Math.random() * 8; // Radius
            drawBubble(v, w, r);
        }
        for (let i = 0; i < 10; i++) {
            let v = Math.random() * (300 - 350) + 330;
    ...
    function drawFish(_x, _y) {
        let gradient = crc2.createLinearGradient(300, 550, 300, 500);
